(function(){
  ...
  function renderAuth(){
    ...
    return `<div class="wrap"><div class="authbox">
      ...
      <p class="sub">${signup? 'Create your account — you can browse, buy, rent, or list a house once you\'re in.' : 'Welcome back to House in Hawassa.'}</p>
      <form data-form="auth">
  ...
  function attachEvents(){
    ...
    if(authForm) authForm.addEventListener('submit', async (e)=>{
      ...
      if(state.authMode==='signup') await doSignup(username, password, (fd.get('phone')||'').toString(), (fd.get('city')||'').toString());
