(function(){
  ...
  function renderNav(){
    ...
    <div class="navbar"><div class="wrap navrow">
      <div class="brand" data-action="go-home"><img src="logo.svg" alt="House logo" class="brand-logo"><span class="en display">House</span><span class="am">የቤት · house marketplace</span></div>
      <div class="navlinks">
        ${adminBit}
